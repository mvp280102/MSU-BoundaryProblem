...
_Bool ContainsString(wchar_t *string, size_t stringLength, wchar_t *substring, size_t substringLength)
{
    return IndexOfString(string, stringLength, substring, substringLength,
                         (NumberReference *) Allocate(sizeof(NumberReference)));
}
...
StringReference **
SplitByString(size_t *returnArrayLength, wchar_t *toSplit, size_t toSplitLength, wchar_t *splitBy, size_t splitByLength)
{
    StringReference **split;
    size_t splitLength;
    wchar_t *next;
